...
public interface ICompanyOrchestrationService
{
    ...
    /// </summary>
    Task<CompanySyncResult> SyncCompaniesToKekaAsync(KekaEmployee? defaultProjectManager, string defaultBillingType, CancellationToken cancellationToken = default);
