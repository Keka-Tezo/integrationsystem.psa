    ...
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                // Configuration is supplied via appsettings.json plus environment variable
                // overrides (Section__Key) at container startup. No cloud SDK dependency —
                // sync state is persisted to a local/mounted JSON file store.
